...
class PacketHandler:
	...
	It can also be fed an instance of VictimParameters directly if working in broadcast mode and attacking all clients.
	'''
	...
	def get_request(self, pkt):
		'''Extracts request payload as a string from the packet object if there is a payload, otherwise returns None.'''
